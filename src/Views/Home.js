        ...
        <div className={classes.root}>
            ...
            <div className={classes.content}>
                <Container className={classes.container}>
                    ...
                    <Typography className={classes.text}>El <Link href='https://github.com/soulblckdstroyer/BrainCEMISID-on-Web'>Backend</Link> y el Frontend completo de este proyecto puede ser encontrado y descargado desde el sus respectivos repositorios en GitHub, e instalados siguiendo sus respectivas instrucciones de instalación, en caso de dudas favor contactar a los propietarios del repositorio según sea el caso.</Typography>
